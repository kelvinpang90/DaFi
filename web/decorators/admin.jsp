        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav">
                        <li><a href="${pageContext.request.contextPath}/back/index.jsp">DaFi Studio</a></li>
                        <li><a href="${pageContext.request.contextPath}/back/microFilm/microFilmList.jsp">微电影</a></li>
                        <li><a href="${pageContext.request.contextPath}/back/wedding/weddingList.jsp">婚礼视频</a></li>
                        <li><a href="${pageContext.request.contextPath}/back/comment/commentList.jsp">评论管理</a></li>
